...
| [`06_erd.md`](docs/06_erd.md) | Entity model and cardinality |
...
| [`09_ui_specification.md`](docs/09_ui_specification.md) | Visual direction, tokens, components, and interaction rules |
...
| [`12_seed_data_specification.md`](docs/12_seed_data_specification.md) | Synthetic demo personas, batches, and reference data |
