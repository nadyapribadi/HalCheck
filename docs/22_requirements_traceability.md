...
| PRD-CT-005 | Fail recorded with equal permanence | FRD-CHAIN-LEDGER-004, VERDICT-005/006 | Architecture §9 | Batch SL-2026-002 (Seed Data §5) | Enforcement Matrix — Fail handling | — |
| PRD-CT-006 | Corrections create new records only | FRD-CHAIN-LEDGER-002–003 | TRD §17 | Correction display rule | Enforcement Matrix — Fail handling | T-008 |
...
| PRD-CT-009 | Recognition-directionality labeled | FRD-CHAIN-VERDICT-002–003 | TRD §22 | Verdict Detail (Screen Req §8) | Journey #3 | — |
...
| PRD-CT-013 | Controlled vocabulary, no free text | FRD-CHAIN-UPLOAD-006–009 | TRD §6/§8 | SearchableSelect (Screen Req §6) | Enforcement Matrix — Controlled vocabulary bypass | — |
...
**Outstanding, tracked separately:** none remaining above Low severity as of this document's issue — see Decision Log ADR-CT-020 for the process governing any future scope addition's traceability impact.
